...
class Config(object):
    def __init__(self):
        self.filepath_disp_training = '../Dataset/TrainingDataset/USA/disp_combine_gaussian_map/'
        self.filepath_vs_training   = '../Dataset/TrainingDataset/USA/vs_curve/'
        ...
        self.testsize=0.2
        self.pretrained =False        # False: train; True: test/predict
        self.start=1                  # load the index number model to train or test/predict 
